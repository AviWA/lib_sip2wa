...
unless (caller) {
    ...
    use lib '/home/ak/org/libbaresip-android/openssl/util/perl';
    use OpenSSL::fallback '/home/ak/org/libbaresip-android/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/ak/org/libbaresip-android/openssl/Configurations';
        use gentemplate;
